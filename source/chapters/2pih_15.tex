...
\sdialogue{TISIPHONE:}You’re beginning backwards!\\
\sdialogue{MEGAERA:}Aye, the first thing in the visit is to say:\\
\sdialogue{ALECTO:}How do you do, and shake hands, then state your name and business.\\
\sdialogue{THE THREE (TOGETHER):}That’s manners!\\
\sdialogue{ERIN:}Really? Well, my name is Erin, and I’m following the woman in the green dress{\el}\\
\sdialogue{TISIPHONE:}No, no, no.\\
\sdialogue{MEGAERA:}You can’t go yet.\\
\sdialogue{ALECTO:}No, the visit has just started.\\
\sdialogue{ERIN:}I’m very sorry.\\
\sdialogue{TISIPHONE:}Would you like to play hide and seek?\\
\sdialogue{MEGAERA:}Or, button\mbox{--}button, who’s got the button?\\
\sdialogue{ALECTO:}So much time, and so little to do.\\
\sdialogue{TISIPHONE:}Wait a minute.\\
\sdialogue{MEGAERA:}Strike that.\\
\sdialogue{ALECTO:}Reverse it.\\
\sdialogue{ERIN:}No, thank you.\\
\sdialogue{THE THREE (TOGETHER):}If you stay long enough, we might have a battle!\\
\sdialogue{ERIN:}That’s very kind of you, but I really must be going.\\
\sdialogue{THE THREE (TOGETHER):}Why?\\
\sdialogue{ERIN:}Because I’m following the woman in the green dress!\\
\sdialogue{THE THREE (TOGETHER):}Why?\\
\sdialogue{ERIN:}Well{\el} I’m curious to know where she is going.\\
\sdialogue{TISIPHONE:}Oh{\el} She’s curious{\el}\\
\sdialogue{MEGAERA:}The three brothers were curious, too, weren’t they?\\
\sdialogue{ALECTO:}Aye, and you remember what happened to them{\el}\\
\sdialogue{THE THREE (TOGETHER):}Poor things!\\
\sdialogue{ERIN:}Why, what happened to them?\\
\sdialogue{TISIPHONE:}Oh, you wouldn’t be interested.\\
\sdialogue{MEGAERA:}No, no, not one bit.\\
\sdialogue{ALECTO:}Not interested at all.\\
\sdialogue{ERIN:}But I am!\\
\sdialogue{TISIPHONE:}Oh, no, you’re in much too much of a hurry!\\
\sdialogue{MEGAERA:}Yes, much too much of a hurry to listen to silly fairy tales.\\
\sdialogue{ALECTO:}Yes, yes, for where is fancy bred? In the heart, or in the head?\\
\sdialogue{ERIN:}Well, I suppose I could stay a bit longer{\el}\\
\sdialogue{THE THREE (TOGETHER):}You could?! Well{\el}

\attrib{\mbox{---}\emph{“The Last Days of Exses O’Bruinan”}\\by S. Leigh, as staged in the 1979 London production.}%Attrib end	
}%endplayscript
{You’re beginning backwards!} %Dialogue size 
...
The levity had left Cadmus’ voice. His eyes darted back and forth between the line, the triangular cup, and the circular coin. “But\mbox{---}”
...
\SmallVSpace
\prophecy{“Þregen béon Pefearles suna and þrie hira tól þissum Déað béo gewunen.”}
\SmallVSpace
