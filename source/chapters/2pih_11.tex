...
\letterClosing{\mbox{--}Excerpted from the private correspondence between Richard Potter, Son of Henry, and Louis Malfoy, son of Armand.}}
\end{writtenNote} \normalsize
\simpleline
...
\DatePlaceInv{Elizabethan Tearoom}
\begin{flushright}
